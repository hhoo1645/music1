...
client.on("message", message => {
 if (message.content === `${prefix}help`) {
  ...
  const embed = new Discord.RichEmbed() 
      .setColor("#000000")
      .setDescription(`
${prefix}play ? يشغل الاغنيه
${prefix}skip ? يطخطي الاغنيه
${prefix}pause ? توقيف
${prefix}resume ? يشغل 
${prefix}vol ?  100 - 0 الصوت
${prefix}stop ? يخلي البوت يخرج من الروم
${prefix}np ? 
${prefix}queue ? تشغيل بعد قليل
${prefix}viphelp ? خصيت الvip
`);
   message.channel.sendEmbed(embed);
...
client.on('ready', () => {
  console.log(`HulerBot`);
});

client.on('message', msg => {
  if (msg.content === 'ping') {
    msg.reply('Pong!');//جميع الحقوق معفوظه لسرفر هولر
  }
});
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`Mafia`,"http://twitch.tv/S-F")
